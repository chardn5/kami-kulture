  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-16 text-center">
      ...
      <p className="mt-2 text-neutral-600">
        Your payment was received{orderID ? <> — Order ID: <span className="font-mono">{orderID}</span></> : null}.
      </p>

      <div className="mt-8">
        <p className="text-sm text-neutral-700">Returning to home in <span className="font-semibold">{seconds}</span> seconds…</p>
